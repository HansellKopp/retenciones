...
var JsStoreWorker = function (e) {
  ...
  var _r6,
    ...
    return L(t, e), t.prototype.processGroupBy = function () {
      ...
      if (c.avg) if (Object(I.a)(c.avg) === b.c.String) for (n in t) {
        var l = t[n]["sum(" + c.avg + ")"],
            f = t[n]["count(" + c.avg + ")"];
        t[n]["avg(" + c.avg + ")"] = l / f, c.count !== c.avg && delete t[n]["count(" + c.avg + ")"], c.sum !== c.avg && delete t[n]["sum(" + c.avg + ")"];
      } else {
        var p = Object(I.a)(c.count) === b.c.String,
            _ = Object(I.a)(c.sum) === b.c.String;
        ...
        for (n in t) {
          for (var a in c.avg) {
            var y = c.avg[a],
                d = t[n]["sum(" + y + ")"],
                g = t[n]["count(" + y + ")"];
            t[n]["avg(" + y + ")"] = d / g, p && (c.count !== y ? delete t[n]["count(" + y + ")"] : -1 === c.count.indexOf(y) && delete t[n]["count(" + y + ")"]), _ && (c.sum !== y ? delete t[n]["sum(" + y + ")"] : -1 === c.sum.indexOf(y) && delete t[n]["sum(" + y + ")"]);
          }
        }
      }
      this.results = t;
    ...
    return Q(t, e), t.prototype.executeJoinQuery = function () {
      ...
      }) ? n = new O.a(b.d.InvalidJoinQuery, "column " + r.column + " does not exist in table " + r.table) : null == u.columns.find(function (e) {
    ...
    return V(t, e), t.prototype.execute = function () {
      ...
      var t,
        ...
        o = !1, n.length > 0 ? (e.results = [], c()) : (e.results = i, !0 === e.isSubQuery && e.onTransactionCompleted_());
          ...
          c = function c() {
        e.query.where = n.shift(), e.query.where[b.g.Or] && 1 === Object.keys(e.query.where).length ? (t = b.g.Or, e.query.where = e.query.where[b.g.Or], e.onWhereArrayQrySuccess = u) : (t = b.g.And, e.onWhereArrayQrySuccess = u), e.processWhere_();
      };
